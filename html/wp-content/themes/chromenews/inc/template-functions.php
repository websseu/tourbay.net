...
function chromenews_body_classes($classes)
{
    ...
    $global_post_title_hover = chromenews_get_option('global_post_title_hover');
    if (!empty($global_post_title_hover)) {
        $classes[] = $global_post_title_hover;
    }
    ...
    $banner_layout = chromenews_get_option('global_site_layout_setting');
    ...
    if ($banner_layout == 'wide') {
        ...
        $classes[] = 'af-boxed-layout';
            ...
            $global_topbottom_gaps = chromenews_get_option('global_site_layout_topbottom_gaps');
